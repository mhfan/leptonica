#!/bin/bash
 ################################################################
 # $ID: build.sh       Wed, 24 Apr 2013 17:25:40 +0800  mhfan $ #
 #                                                              #
 # Description:                                                 #
 #                                                              #
...
cd src  && #make -f makefile.static SHARED=yes shared -j2
	    make -f makefile.static nodebug -j2 &&
cd -

cd prog && #make -f makefile.static SHARED=yes shared -j2
	    make -f makefile.static -j2 &&
exit 0

################################################################################
#`configure' configures leptonica 1.69 to adapt to many kinds of systems.
#
...
#
#Report bugs to <dan.bloomberg@gmail.com>.
# vim:sts=4:ts=8:
